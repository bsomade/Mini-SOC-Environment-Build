...
6) Use EQL to run custom detection in elastic. <img width="1520" height="627" alt="Using EQL to run a custom detection in elastic_1 1" src="https://github.com/user-attachments/assets/5d47ba12-bd98-48be-b669-669dc96cedc9" /> <img width="1511" height="510" alt="Using EQL to run a custom detection in elastic_2 1" src="https://github.com/user-attachments/assets/daec0693-02f1-4b6a-9366-ef054b704c8b" />
